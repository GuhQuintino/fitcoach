...
const LoadingScreen: React.FC = () => {
    ...
    return (
        <div
            role="status"
            aria-live="polite"
            className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-900 overflow-hidden"
        >
            ...
            <div className="relative flex flex-col items-center max-w-sm px-6 text-center">
                ...
                <div className="relative w-20 h-20 mb-8">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className="material-symbols-rounded text-primary text-3xl transition-transform duration-300" aria-hidden="true">fitness_center</span>
                    </div>
                </div>
                ...
                <div className="w-48 h-1 bg-slate-200 dark:bg-slate-800 rounded-full mt-8 overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-primary to-emerald-400 w-1/3 rounded-full animate-pulse shadow-sm shadow-primary/50"></div>
                </div>
            </div>
        </div>
    );
