...
VALUES ('Incline Push-Up Reverse Grip', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Push-Up_Reverse_Grip/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Incline Push-Up Wide', 'chest', '', '## Overview
Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Push-Up_Wide/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Intermediate Groin Stretch', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Intermediate_Groin_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Intermediate Hip Flexor and Quad Stretch', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Intermediate_Hip_Flexor_and_Quad_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Internal Rotation with Band', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Internal_Rotation_with_Band/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Inverted Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Inverted_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Inverted Row with Straps', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Inverted_Row_with_Straps/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Iron Cross', 'shoulders', '', '## Overview


![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Iron_Cross/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Iron Crosses (stretch)', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Iron_Crosses_stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Isometric Chest Squeezes', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Isometric_Chest_Squeezes/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Isometric Neck Exercise - Front And Back', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Isometric_Neck_Exercise_-_Front_And_Back/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Isometric Neck Exercise - Sides', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Isometric_Neck_Exercise_-_Sides/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Isometric Wipers', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Isometric_Wipers/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('JM Press', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/JM_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Jackknife Sit-Up', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jackknife_Sit-Up/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Janda Sit-Up', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Janda_Sit-Up/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Jefferson Squats', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jefferson_Squats/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Jerk Balance', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jerk_Balance/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Jerk Dip Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jerk_Dip_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Jogging, Treadmill', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Jogging_Treadmill/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Keg Load', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Keg_Load/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Arnold Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Arnold_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Dead Clean', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Dead_Clean/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Figure 8', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Figure_8/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Hang Clean', 'legs', '', '## Overview
Place kettlebell between your feet. To get in the starting position, push your butt back and look straight ahead.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Hang_Clean/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell One-Legged Deadlift', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_One-Legged_Deadlift/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Pass Between The Legs', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Pass_Between_The_Legs/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Pirate Ships', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Pirate_Ships/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Pistol Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Pistol_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Seated Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Seated_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Seesaw Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Seesaw_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Sumo High Pull', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Sumo_High_Pull/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Thruster', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Thruster/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Turkish Get-Up (Lunge style)', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Turkish_Get-Up_Lunge_style/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Turkish Get-Up (Squat style)', 'shoulders', '', '## Overview
Lie on your back on the floor and press a kettlebell to the top position by extending the elbow. Bend the knee on the same side as the kettlebell.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Turkish_Get-Up_Squat_style/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kettlebell Windmill', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kettlebell_Windmill/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kipping Muscle Up', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kipping_Muscle_Up/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Knee Across The Body', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Knee_Across_The_Body/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Knee Circles', 'legs', '', '## Overview
Stand with your legs together and hands by your waist.
Now move your knees in a circular motion as you breathe normally.
Repeat for the recommended amount of repetitions.

![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Knee_Circles/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Knee/Hip Raise On Parallel Bars', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Knee_Hip_Raise_On_Parallel_Bars/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Knee Tuck Jump', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Knee_Tuck_Jump/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Arm Drill', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Arm_Drill/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Cable Crunch With Alternating Oblique Twists', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Cable_Crunch_With_Alternating_Oblique_Twists/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Cable Triceps Extension', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Cable_Triceps_Extension/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Forearm Stretch', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Forearm_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling High Pulley Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_High_Pulley_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Hip Flexor', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Hip_Flexor/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Jump Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Jump_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Single-Arm High Pulley Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Single-Arm_High_Pulley_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Kneeling Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Kneeling_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;
