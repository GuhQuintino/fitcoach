...
VALUES ('Landmine 180''s', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Landmine_180s/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Landmine Linear Jammer', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Landmine_Linear_Jammer/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lateral Bound', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lateral_Bound/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lateral Box Jump', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lateral_Box_Jump/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lateral Cone Hops', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lateral_Cone_Hops/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lateral Raise - With Bands', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lateral_Raise_-_With_Bands/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Latissimus Dorsi-SMR', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Latissimus_Dorsi-SMR/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg-Over Floor Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg-Over_Floor_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg-Up Hamstring Stretch', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg-Up_Hamstring_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg Extensions', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Extensions/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg Lift', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Lift/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg Press', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leg Pull-In', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leg_Pull-In/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Chest Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Chest_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Deadlift', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Deadlift/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Decline Chest Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Decline_Chest_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage High Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_High_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Incline Chest Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Incline_Chest_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Iso Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Iso_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Shoulder Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Shoulder_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Leverage Shrug', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Leverage_Shrug/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Linear 3-Part Start Technique', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Linear_3-Part_Start_Technique/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Linear Acceleration Wall Drill', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Linear_Acceleration_Wall_Drill/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Linear Depth Jump', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Linear_Depth_Jump/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Log Lift', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Log_Lift/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('London Bridges', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/London_Bridges/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Looking At Ceiling', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Looking_At_Ceiling/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Low Cable Crossover', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Low_Cable_Crossover/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Low Cable Triceps Extension', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Low_Cable_Triceps_Extension/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Low Pulley Row To Neck', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Low_Pulley_Row_To_Neck/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lower Back-SMR', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lower_Back-SMR/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lower Back Curl', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lower_Back_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lunge Pass Through', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lunge_Pass_Through/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lunge Sprint', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lunge_Sprint/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Bent Leg Groin', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Bent_Leg_Groin/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Cable Curl', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Cable_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Cambered Barbell Row', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Cambered_Barbell_Row/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Close-Grip Bar Curl On High Pulley', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Close-Grip_Bar_Curl_On_High_Pulley/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Close-Grip Barbell Triceps Extension Behind The Head', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Close-Grip_Barbell_Triceps_Extension_Behind_The_Head/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Close-Grip Barbell Triceps Press To Chin', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Close-Grip_Barbell_Triceps_Press_To_Chin/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Crossover', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Crossover/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Dumbbell Tricep Extension', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Dumbbell_Tricep_Extension/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Face Down Plate Neck Resistance', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Face_Down_Plate_Neck_Resistance/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Face Up Plate Neck Resistance', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Face_Up_Plate_Neck_Resistance/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Glute', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Glute/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Hamstring', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Hamstring/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying High Bench Barbell Curl', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_High_Bench_Barbell_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Leg Curls', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Leg_Curls/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying Machine Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_Machine_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Lying One-Arm Lateral Raise', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Lying_One-Arm_Lateral_Raise/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;
