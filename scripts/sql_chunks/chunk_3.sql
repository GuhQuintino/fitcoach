...
VALUES ('Chair Squat', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chair_Squat/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chair Upper Body Stretch', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chair_Upper_Body_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest And Front Of Shoulder Stretch', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_And_Front_Of_Shoulder_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest Push from 3 point stance', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_Push_from_3_point_stance/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest Push (multiple response)', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_Push_multiple_response/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest Push (single response)', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_Push_single_response/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest Push with Run Release', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_Push_with_Run_Release/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chest Stretch on Stability Ball', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chest_Stretch_on_Stability_Ball/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Child''s Pose', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Childs_Pose/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chin-Up', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chin-Up/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Chin To Chest Stretch', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Chin_To_Chest_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Circus Bell', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Circus_Bell/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean Deadlift', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_Deadlift/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean Pull', 'legs', '', '## Overview
With a barbell on the floor close to the shins, take an overhand or hook grip just outside the legs. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_Pull/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean Shrug', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_Shrug/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean and Jerk', 'shoulders', '', '## Overview
With a barbell on the floor close to the shins, take an overhand or hook grip just outside the legs. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
Begin the first pull by driving through the heels, extending your knees. Your back angle should stay the same, and your arms should remain straight. Move the weight with control as you continue to above the knees.
Next comes the second pull, the main source of acceleration for the clean. As the bar approaches the mid-thigh position, begin extending through the hips. In a jumping motion, accelerate by extending the hips, knees, and ankles, using speed to move the bar upward. There should be no need to actively pull through the arms to accelerate the weight; at the end of the second pull, the body should be fully extended, leaning slightly back, with the arms still extended.
As full extension is achieved, transition into the third pull by aggressively shrugging and flexing the arms with the elbows up and out. At peak extension, aggressively pull yourself down, rotating your elbows under the bar as you do so. Receive the bar in a front squat position, the depth of which is dependent upon the height of the bar at the end of the third pull. The bar should be racked onto the protracted shoulders, lightly touching the throat with the hands relaxed. Continue to descend to the bottom squat position, which will help in the recovery.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_and_Jerk/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean and Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_and_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clean from Blocks', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_from_Blocks/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Clock Push-Up', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clock_Push-Up/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip Barbell Bench Press', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_Barbell_Bench_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip Dumbbell Press', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_Dumbbell_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip EZ-Bar Curl with Band', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_EZ-Bar_Curl_with_Band/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip EZ-Bar Press', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_EZ-Bar_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip EZ Bar Curl', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_EZ_Bar_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip Front Lat Pulldown', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_Front_Lat_Pulldown/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip Push-Up off of a Dumbbell', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_Push-Up_off_of_a_Dumbbell/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Close-Grip Standing Barbell Curl', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Close-Grip_Standing_Barbell_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Cocoons', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cocoons/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Conan''s Wheel', 'legs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Conans_Wheel/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Concentration Curls', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Concentration_Curls/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Cross-Body Crunch', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cross-Body_Crunch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Cross Body Hammer Curl', 'arms', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cross_Body_Hammer_Curl/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Cross Over - With Bands', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cross_Over_-_With_Bands/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Crossover Reverse Lunge', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crossover_Reverse_Lunge/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Crucifix', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crucifix/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Crunch - Hands Overhead', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crunch_-_Hands_Overhead/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Crunch - Legs On Exercise Ball', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crunch_-_Legs_On_Exercise_Ball/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Crunches', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Crunches/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Cuban Press', 'shoulders', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Cuban_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Dancer''s Stretch', 'back', '', '## Overview
Sit up on the floor.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dancers_Stretch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Dead Bug', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dead_Bug/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Deadlift with Bands', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Deadlift_with_Bands/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Deadlift with Chains', 'back', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Deadlift_with_Chains/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Barbell Bench Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Barbell_Bench_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Close-Grip Bench To Skull Crusher', 'arms', '', '## Overview
Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Close-Grip_Bench_To_Skull_Crusher/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Crunch', 'abs', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Crunch/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Dumbbell Bench Press', 'chest', '', '## Overview
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Dumbbell_Bench_Press/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Dumbbell Flyes', 'chest', '', '## Overview
Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Dumbbell_Flyes/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;


INSERT INTO exercises (name, muscle_group, video_url, description, is_public)
VALUES ('Decline Dumbbell Triceps Extension', 'arms', '', '## Overview
Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
Once you are laying down, move the dumbbells in front of you at shoulder width. The palms of the hands should be facing each other and the arms should be perpendicular to the floor and fully extended. This will be your starting position.
...
![Demonstration](https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Dumbbell_Triceps_Extension/0.jpg)', true)
ON CONFLICT (name) DO NOTHING;
